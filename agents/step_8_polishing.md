...
- [ ] `references/term_aliases.md` — 🆕 术语标准化映射（以本表为基准校验术语一致性）
- [ ] `references/error_log.md` — 已知 AI 痕迹模式及修复规则
- [ ] `references/decision_log.md` — 影响润色策略的决策
...
**以 `references/term_aliases.md` 为基准：**

1. 加载 `references/term_aliases.md` 获取标准术语映射表
2. 逐章扫描正文，提取所有核心术语
3. 对比映射表：
   - 术语是否与 Main Term 一致？
...
4. 不一致处理：
   ...
   - 如果 Main Term 选择不当 → 更新 `references/term_aliases.md` → 记录到 `references/decision_log.md`
   - 如果属于新术语 → 追加到 `references/term_aliases.md`
...
- [ ] 🆕 术语一致性检查完成——以 `references/term_aliases.md` 为基准，全文术语一致
...
### 术语一致性报告 🆕
- [ ] 全文核心术语已与 `references/term_aliases.md` 对齐
- [ ] 术语修改数：X 处
...
### 错误日志更新 🆕
- [ ] 本轮是否发现了新的 AI 痕迹模式？
  - 如有 → 追加到 `references/error_log.md`，更新 Level 3 模式清单
- [ ] 术语不一致是否为系统性错误？
  - 如有 → 追加到 `references/error_log.md`，更新 Step 2/3/7 的术语规则

### 决策日志更新 🆕
- [ ] 是否调整了句长波动目标？→ 记录到 `references/decision_log.md`
- [ ] 是否修改了术语 Main Term 选择？→ 记录到 `references/decision_log.md`

---

## 9. 故障排除 (Troubleshooting)

- **AI 痕迹除不尽**：回查 `references/error_log.md` 中的 AI 痕迹记录；Level 3 分类逐类排查
- **术语不一致**：以 `references/term_aliases.md` 为唯一基准，不依赖直觉判断
